            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Tambah Acara Baru</h4>
                        <p class="f-m-light mt-1">
                            Isi formulir di bawah ini untuk menambahkan acara baru. Semua kolom yang diberi tanda <span class="text-danger">*</span> wajib diisi.
                        </p>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 needs-validation custom-input position-relative" 
                            ...
                            <div class="col-12 position-relative">
                                <label class="form-label" for="validationTooltipImages">Foto Acara</label>
                            ...
                            <div class="col-12 mt-4 border-top pt-3">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button class="btn btn-primary" type="submit">
                                        <i class="fa fa-save me-1"></i> Tambah Acara
                                    </button>
                                </div>
                            </div>
                        </form>
