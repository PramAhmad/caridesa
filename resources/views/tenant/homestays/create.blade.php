                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Isi formulir di bawah ini untuk menambahkan homestay baru. Semua kolom yang diberi tanda <span class="text-danger">*</span> wajib diisi.
                        </p>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 needs-validation custom-input position-relative" 
                            action="/admin/homestays" 
                            method="POST" 
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="validationTooltipStatus" {{ old('is_active') ? 'checked' : '' }}>
                                    <label class="form-check-label" for="validationTooltipStatus">
                                        Aktif
                                    </label>
                                </div>
                                <small class="text-muted">Homestay aktif akan tampil di website</small>
                            </div>
                            ...
                            <div class="col-12 mt-4">
                                <h5 class="border-bottom pb-2 mb-3">📸 Galeri Foto</h5>
                            </div>
                            
                            <div class="col-12 position-relative">
                                <label class="form-label" for="validationTooltipImages">Foto Homestay</label>
                            ...
                            <div class="col-12 mt-4 border-top pt-3">
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button class="btn btn-primary" type="submit">
                                        <i class="fa fa-save me-1"></i> Tambah Homestay
                                    </button>
                                </div>
                            </div>
                        </form>
