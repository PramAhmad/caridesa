...
document.addEventListener('DOMContentLoaded', function() {
    ...
    homestayFilterBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            // Force grid reflow for proper layout
    ...
    // Observe all cards
    document.querySelectorAll('.product-card, .guide-card, .destination-card, .homestay-card, .event-card').forEach(card => {
