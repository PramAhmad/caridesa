            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit Kategori: {{ $categoryWisata->name }}</h4>
                        <p class="f-m-light mt-1">
                            Perbarui informasi kategori wisata. Semua kolom yang diberi tanda <span class="text-danger">*</span> wajib diisi.
                        </p>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 needs-validation custom-input position-relative" 
                            action="{{ route('category-wisatas.update', $categoryWisata) }}" 
                            method="POST" 
                            novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" 
                                    ...
                                    type="text" 
                                    name="name"
                                    value="{{ old('name', $categoryWisata->name) }}"
                                ...
                                @enderror
                                <small class="text-muted">Slug saat ini: <code>{{ $categoryWisata->slug }}</code></small>
                            </div>
                            ...
                            <div class="col-md-6 position-relative">
                                <div class="form-check form-switch mt-4">
                                    <input class="form-check-input" 
                                           ...
                                           name="is_active" 
                                           value="1" 
                                           {{ old('is_active', $categoryWisata->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="col-12 position-relative">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                        ...
                                        name="description"
                                        rows="4"
                                        placeholder="Deskripsi singkat tentang kategori wisata ini...">{{ old('description', $categoryWisata->description) }}</textarea>
                                <div class="valid-tooltip">Terlihat bagus!</div>
                                @error('description')
                                    <div class="invalid-tooltip">{{ $message }}</div>
                                @enderror
