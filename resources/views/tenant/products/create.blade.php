                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="f-m-light mt-1">
                            Isi detail produk dengan lengkap untuk menarik lebih banyak pembeli.
                        </p>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                                ...
                                <select class="form-select @error('category_product_id') is-invalid @enderror" 
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{ $category->id }}" 
                                                {{ old('category_product_id', $selectedCategory) == $category->id ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <select class="form-select @error('stock') is-invalid @enderror" 
                                    ...
                                    @foreach(App\Enum\ProductStockStatus::cases() as $status)
                                        <option value="{{ $status->value }}" 
                                                {{ old('stock') == $status->value ? 'selected' : '' }}>
                                            {{ $status->label() }}
                                        </option>
                                    @endforeach
                                </select>
