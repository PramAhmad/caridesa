            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Edit Kategori: {{ $categoryProduct->name }}</h4>
                        <p class="f-m-light mt-1">
                            Perbarui informasi kategori produk. Semua kolom yang diberi tanda <span class="text-danger">*</span> wajib diisi.
                        </p>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 needs-validation custom-input position-relative" 
                            ...
                            <div class="col-md-6 position-relative">
                                <label class="form-label" for="validationTooltipName">Nama Kategori <span class="text-danger">*</span></label>
                                <input class="form-control @error('name') is-invalid @enderror" 
                                    id="validationTooltipName" 
                                    type="text" 
                                    name="name"
                                    value="{{ old('name', $categoryProduct->name) }}"
                                    placeholder="Makanan Tradisional" 
                                    required>
                                <div class="valid-tooltip">Terlihat bagus!</div>
                                @error('name')
                                    <div class="invalid-tooltip">{{ $message }}</div>
                                @enderror
                                <small class="text-muted">Slug saat ini: <code>{{ $categoryProduct->slug }}</code></small>
                            </div>
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                <small class="text-muted">Kategori aktif akan ditampilkan di daftar produk</small>
                            </div>
                            ...
                            <div class="col-12 position-relative">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                        ...
                                        name="description"
                                        rows="4"
                                        placeholder="Deskripsi singkat tentang kategori produk ini...">{{ old('description', $categoryProduct->description) }}</textarea>
                                <div class="valid-tooltip">Terlihat bagus!</div>
                                @error('description')
                                    <div class="invalid-tooltip">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12 mt-4 border-top pt-3">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('category-products.index') }}" class="btn btn-light">
                                        Batal
                                    </a>
