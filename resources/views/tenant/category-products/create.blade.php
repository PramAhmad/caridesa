            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Tambah Kategori Produk Baru</h4>
                        <p class="f-m-light mt-1">
                            Isi formulir di bawah ini untuk membuat kategori produk baru. Semua kolom yang diberi tanda <span class="text-danger">*</span> wajib diisi.
                        </p>
                    </div>
                    <div class="card-body">
                        <form class="row g-3 needs-validation custom-input position-relative" 
                            ...
                            <div class="col-12 position-relative">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                        ...
                                        name="description"
                                        rows="4"
                                        placeholder="Deskripsi singkat tentang kategori produk ini...">{{ old('description') }}</textarea>
                                <div class="valid-tooltip">Terlihat bagus!</div>
                                @error('description')
                                    <div class="invalid-tooltip">{{ $message }}</div>
                                @enderror
